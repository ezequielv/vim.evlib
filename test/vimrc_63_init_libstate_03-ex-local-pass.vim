" test/vimrc_63_init_libstate_03-ex-local-pass.vim
...
call EVLibTest_LibStages_FullSuite_UserScriptThrow( 'initialisation - library state checks ("post" user script throws)', 'post' )
